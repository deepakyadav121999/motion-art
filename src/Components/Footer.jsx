...
const Footer = () => {
  return (
    ...
    <div className='bg-gray-900 flex flex-col justify-center items-center gap-10'>
        <div className='flex flex-col justify-center crmo w-11/12 p-5 items-center text-white rounded-md '>
            <div className='flex flex-col sm:w-3/5 p-2 text-center'>
             <p className='text-3xl'>Supported by All Popular Browsers</p>
            <p className='text-gray-400 text-xl'>Rest assured, Motion Art is designed to be compatible with all major web browsers.</p>
            </div>
        ...
        <div className='flex flex-col items-center'>
            ...
            <div className='flex  justify-center p-4 flex-wrap text-white gap-8'>
                <div className='sm:w-1/4 p-2 bg-gray-800 rounded-xl  abc'>
